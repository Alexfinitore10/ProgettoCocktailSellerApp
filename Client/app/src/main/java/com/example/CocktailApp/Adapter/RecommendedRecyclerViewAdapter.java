...
public class RecommendedRecyclerViewAdapter extends RecyclerView.Adapter<RecommendedRecyclerViewAdapter.ViewHolder> {
    ...
    public RecommendedRecyclerViewAdapter(ArrayList<RecommendedLayoutClass> recommendedLayoutArrayList, Context context, ArrayList<Cocktail> cocktailList, ArrayList<Shake> shakeList) {
