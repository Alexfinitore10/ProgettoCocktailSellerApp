...
public class Carrello {
    ...
    public void viewItems() {
        System.out.println("+---------------+---------------------------------------------+-------------------+---------------+");
        System.out.println("|   Cocktails   |                    Ingredienti              | Gradazione Alcolica|    Prezzo     |");
        System.out.println("+---------------+---------------------------------------------+-------------------+---------------+");
        if (cocktails.isEmpty()) {
            System.out.println("| Nessun cocktail nel carrello.                                              |");
        } else {
            for (Cocktail cocktail : cocktails) {
                System.out.printf("| %-13s | %-21s | %-17.1f | %-13.2f |%n", cocktail.getNome(), cocktail.getIngredienti(), cocktail.getGradazione_alcolica(), cocktail.getPrezzo());
            }
        }
        System.out.println("+---------------+---------------------------------------------+---------------+");
        ...
        if (shakes.isEmpty()) {
            ...
            for (Shake shake : shakes) {
                System.out.printf("| %-13s | %-21s | %-17.2f |%n", shake.getNome(), shake.getIngredienti(), shake.getPrezzo());
            }
        }
        System.out.println("+---------------+-----------------------+-------------------+---------------+");
    }
