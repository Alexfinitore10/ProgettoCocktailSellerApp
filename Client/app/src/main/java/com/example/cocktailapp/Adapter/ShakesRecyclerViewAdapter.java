...
public class ShakesRecyclerViewAdapter extends RecyclerView.Adapter<ShakesRecyclerViewAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ShakesRecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        String PrezzoShake = shakesLayoutClass.getPrezzo().toString();
    ...
    public void updateData(ArrayList<Shake> shakeslist, ArrayList<ShakesLayoutClass> list){
        this.shakeslist.clear();
        this.shakeslist.addAll(shakeslist);
        this.shakeslayoutlist.clear();
        this.shakeslayoutlist.addAll(list);
        notifyDataSetChanged();
    }

    public void setShakeslist(ArrayList<Shake> shakeslist) {
        this.shakeslist = shakeslist;
    }
